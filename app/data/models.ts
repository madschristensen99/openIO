...
export const models: Model[] = [
  ...
  {
    id: 'zk-verifier',
    name: 'Circom ZK Verifier',
    author: 'openio',
    category: 'zk',
    description: 'Native Circom zero-knowledge proof verifier with Groth16/PLONK proofs for private computation',
    downloads: '12.4k',
    likes: '1.2k',
    updated: 'Just now',
    parameters: '2.3M gates | Boundless ready',
    tags: ['ZK', 'CIRCOM', 'verification', 'private'],
  },
  {
    id: 'zk-stark-verifier',
    name: 'Cairo ZK STARK Verifier',
    author: 'openio',
    category: 'zk',
    description: 'High-performance Cairo/STARK ZK proof verification on Starknet with quantum resistance',
    downloads: '8.7k',
    likes: '856',
    updated: 'Just now',
    parameters: 'Zero-knowledge STARK | Cairo contracts',
    tags: ['ZK', 'STARK', 'Cairo', 'quantum-proof'],
  },
  {
    id: 'zk-arbitrage',
    name: 'Private Arbitrage Detector',
    author: 'openio',
    category: 'zk',
    description: 'ZK circuit for detecting profitable arbitrage opportunities across DEXs without revealing strategy',
    downloads: '15.2k',
    likes: '2.1k',
    updated: 'Just now',
    parameters: '8.7M gates | Live pricing',
    tags: ['ZK', 'arbitrage', 'DEX', 'private'],
  },
  {
    id: 'zk-swap',
    ...
    author: 'openio',
    category: 'zk',
    description: 'Zero-knowledge swap privacy circuit hiding amounts, parties, and transaction details',
    downloads: '9.1k',
    likes: '643',
    updated: 'Just now',
    parameters: '4.2M gates | ERC20/ETH ready',
    tags: ['ZK', 'swap', 'private', 'uniswap'],
  },
  {
    id: 'zk-governance',
    ...
    author: 'openio',
    category: 'zk',
    description: 'Anonymous voting mechanism preserving privacy of vote choices and voter identity',
    downloads: '7.3k',
    likes: '1.5k',
    updated: 'Just now',
    parameters: '3.6M gates | DAO governance',
    tags: ['ZK', 'voting', 'governance', 'DAO'],
  },
  {
    id: 'zk-identity',
    ...
    author: 'openio',
    category: 'zk',
    description: 'Private identity verification with selective disclosure proving age, citizenship, or credentials',
    downloads: '11.8k',
    likes: '2.3k',
    updated: 'Just now',
    parameters: '6.5M gates | ID verification',
    tags: ['ZK', 'identity', 'KYC', 'credentials'],
  },
